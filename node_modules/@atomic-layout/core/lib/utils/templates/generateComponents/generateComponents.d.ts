 ...
 */
export default function generateComponents({ areas, templates }: AreasList, createAreaComponent: (areaName: string) => AreaComponent, withPlaceholder: (Component: AreaComponent, breakpoints: Breakpoint[]) => AreaComponent): AreasMap;
